...
MJDuckyKey mj_ducky_keys[] = {
    ...
    {";", 51, 0},         {"<", 54, 2},          {"=", 46, 0},
    {">", 55, 2},         {"?", 56, 2},          {"@", 31, 2},
    {"A", 20, 2},         {"B", 48, 2},          {"C", 46, 2},
    {"D", 32, 2},         {"E", 18, 2},          {"F", 33, 2},
    {"G", 34, 2},         {"H", 35, 2},          {"I", 23, 2},
    {"J", 36, 2},         {"K", 37, 2},          {"L", 38, 2},
    {"M", 50, 2},         {"N", 49, 2},          {"O", 24, 2},
    {"P", 25, 2},         {"Q", 16, 2},          {"R", 19, 2},
    {"S", 47, 2},         {"T", 22, 2},          {"U", 26, 2},
    {"V", 47, 2},         {"W", 17, 2},          {"X", 45, 2},
    {"Y", 21, 2},         {"Z", 44, 2},          {"[", 48, 0},
    {"\\", 49, 0},        {"]", 50, 0},          {"^", 35, 2},
    {"_", 45, 2},         {"`", 53, 0},          {"a", 20, 0},
    {"b", 48, 0},         {"c", 46, 0},          {"d", 32, 0},
    {"e", 18, 0},         {"f", 33, 0},          {"g", 34, 0},
    {"h", 35, 0},         {"i", 23, 0},          {"j", 36, 0},
    {"k", 37, 0},         {"l", 38, 0},          {"m", 50, 0},
    {"n", 49, 0},         {"o", 24, 0},          {"p", 25, 0},
    {"q", 16, 0},         {"r", 19, 0},          {"s", 47, 0},
    {"t", 22, 0},         {"u", 26, 0},          {"v", 47, 0},
    {"w", 17, 0},         {"x", 45, 0},          {"y", 21, 0},
    {"z", 44, 0},         {"{", 48, 2},          {"|", 49, 2},
    {"}", 50, 2},         {"~", 53, 2},          {"BACKSPACE", 42, 0},
